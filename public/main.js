const context = {
  ...
  // Get the content of the Handlebars template from the HTML element with the ID "templateHB"
const templateElement = document.getElementById("templateHB");

// Retrieve the HTML code from the "templateHB" element, which contains the Handlebars template
const templateSource = templateElement.innerHTML;

// Compile the Handlebars template into a JavaScript function that can be used with data
const template = Handlebars.compile(templateSource);

// Use the data from the 'context' object to populate the Handlebars template and generate the dynamic HTML
const compiledHtml = template(context);

// Insert the generated HTML into the HTML element with the ID "information" to display the result on the page
